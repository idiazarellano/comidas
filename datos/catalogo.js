...
const CATALOGO = {
  ...
  bases: [
    { id:"B1", nombre:"Sofrito de tomate", conserv:"congela", icono:"🍅",
      rinde:"~1 kg = 10 porciones de 100 g (1 porción por persona en guisos y salsas)",
      porciones:10,
    ...
    { id:"B2", nombre:"Base de curry", conserv:"congela", icono:"🍛",
      rinde:"~900 g = 9 porciones de 100 g (un curry de 3 raciones pide 200–300 g)",
      porciones:9,
    ...
    { id:"B4", nombre:"Lentejas aliñadas", conserv:"nevera4", icono:"🫘", frio:true,
      rinde:"3 tarros = 3 porciones (1 porción = 1 tarro = 1 ensalada de 3 raciones)",
      porciones:3,
      prep:"3 tarros de lenteja cocida, enjuagadas. Aliñar con AOVE, vinagre, sal, cebolla roja picada y perejil.",
    ...
    { id:"B5", nombre:"Tofu crujiente al horno", conserv:"nevera4", icono:"🧈", frio:true,
      rinde:"2 bloques (~500 g) = 5 porciones de 100 g (un tupper de 3 pide 2–3)",
      porciones:5,
    ...
    { id:"B6", nombre:"Boloñesa de lentejas", conserv:"congela", icono:"🍝",
      rinde:"~1,8 kg = 3 porciones de 600 g (1 porción = 1 receta de 3 raciones)",
      porciones:3,
      prep:"600 g de sofrito (B1), 2 zanahorias picadas, 3 tarros de lenteja, orégano, vino tinto. 20 min. Parte de la mezcla, más densa, sirve para formar albóndigas (+ pan rallado + huevo, al horno 20 min).",
      minutos:20, puesto:"fuego", usa:[{id:"B1",porciones:6}],
    ...
    { id:"B9", nombre:"Soja texturizada hidratada", conserv:"congela", icono:"🌾",
      rinde:"~700 g = 3 porciones (1 porción ≈ 80 g seca = 1 receta de 3 raciones, lo mismo que 1 tarro de lentejas)",
      porciones:3,
  ...
  salsas: [
    { id:"S1", nombre:"Tahini-limón", receta:"3 cda de tahini, 1 limón, 1 ajo, agua, sal", conserv:"nevera7", recetas:["T5","T25"],
    ...
    { id:"S3", nombre:"Cacahuete", receta:"crema de cacahuete, soja, lima, jengibre, sirope", conserv:"nevera7", recetas:["T8","T15","T20","F10"],
  ...
  recetas: [
    ...
    { id:"T1", nombre:"Lentejas estofadas", tipo:"tupper", raciones:3, minutos:20, calentar:true, congela:true,
      ...
      fresco:[{n:"tarro de lenteja cocida",c:"1",p:"tarros"},{n:"zanahoria",c:"2",p:"verdura"},{n:"patata",c:"3",p:"verdura"},{n:"pimentón",c:"",p:"despensa"},{n:"laurel",c:"",p:"despensa"}],
      alDia:["1 huevo cocido por ración (B7)"],
      pasos:"1 tarro de lenteja + 300 g de sofrito (B1, 100 g por persona) + 2 zanahorias + 3 patatas (1 por ración) en dados pequeños (así aguanta mejor el congelado; si no, queda harinosa) + 1 cda de AOVE + pimentón + laurel + agua justa, sin cubrir de más. 20 min. Al final, aplastar unas cuantas patatas y lentejas contra la olla para que el caldo espese.",
    ...
    { id:"T2", nombre:"Dal de lentejas rojas y espinacas", tipo:"tupper", raciones:3, minutos:25, calentar:true, congela:true,
      bases:[{id:"B2",porciones:2}], salsas:["S2"],
      ...
      pasos:"200 g de base de curry (B2) + 180 g de lenteja roja seca (se hace en 15 min, sin remojo ni olla) + 250 ml de coco + 400 ml de agua. 15 min. Añadir 120 g de espinaca. Complemento opcional: 2 cda de arroz.",
    ...
    { id:"T3", nombre:"Curry de tofu y coliflor", tipo:"tupper", raciones:3, minutos:20, calentar:true, congela:true,
      bases:[{id:"B2",porciones:3},{id:"B5",porciones:2},{id:"B8",porciones:1}], salsas:[],
      fresco:[{n:"coliflor",c:"3/4",p:"verdura"},{n:"leche de coco",c:"150 ml",p:"despensa"},{n:"arroz basmati",c:"150 g",p:"despensa"}],
      pasos:"300 g de B2 + 150 ml de coco + ¾ de coliflor en ramitos + las verduras en juliana (B8), 12 min. Añadir 200 g de tofu crujiente (B5) al final. Con 150 g de arroz basmati (50 g por ración).",
    ...
    { id:"T6", nombre:"Tortilla de horno de verduras", tipo:"tupper", raciones:3, minutos:40, frio:true, congela:true,
      ...
      fresco:[{n:"huevos",c:"8",p:"proteina"},{n:"queso rallado",c:"80 g",p:"proteina"}],
      pasos:"8 huevos + 200 g de B3 + 80 g de queso. Molde de 20×25, 180 °C, 25–30 min. Acompañar con tomate o un poco de romesco.",
    ...
    { id:"T8", nombre:"Tofu crujiente, brócoli y cacahuete", tipo:"tupper", raciones:3, minutos:15, calentar:true, frio:true, congela:false,
      bases:[{id:"B5",porciones:3}], salsas:["S3"],
      fresco:[{n:"brócoli",c:"1",p:"verdura"},{n:"arroz",c:"150 g",p:"despensa"},{n:"sésamo",c:"",p:"despensa"}],
      alDia:["salsa de cacahuete aparte"],
      pasos:"300 g de tofu (B5) + 1 brócoli al horno o al vapor, 8 min. Con 150 g de arroz (50 g por ración). Salsa de cacahuete aparte y sésamo por encima.",
    ...
    { id:"T9", nombre:"Pisto con huevo", tipo:"tupper", raciones:3, minutos:35, calentar:true, congela:true,
      bases:[{id:"B1",porciones:3}], salsas:[],
      fresco:[{n:"calabacín",c:"1",p:"verdura"},{n:"berenjena",c:"1",p:"verdura"},{n:"huevos",c:"6",p:"proteina"},{n:"arroz",c:"120 g",p:"despensa"}],
      alDia:["2 huevos por ración, cocidos, poché o fritos"],
      pasos:"300 g de B1 + calabacín y berenjena en dados, 25 min. Con 120 g de arroz blanco (40 g por ración) y 2 huevos por ración.",
    ...
    { id:"T10", nombre:"Crema de calabaza y lenteja roja", tipo:"tupper", raciones:3, minutos:25, calentar:true, congela:true,
      ...
      fresco:[{n:"puerro",c:"1",p:"verdura"},{n:"lenteja roja seca",c:"150 g",p:"despensa"},{n:"caldo de verduras",c:"800 ml",p:"despensa"},{n:"pipas",c:"",p:"despensa"}],
      alDia:["feta, pipas y yogur por encima"],
      pasos:"400 g de calabaza asada (B3) + 1 puerro + 150 g de lenteja roja + 800 ml de caldo. 15 min y triturar.",
    ...
    { id:"T11", nombre:"Berenjenas rellenas de boloñesa de lentejas", tipo:"tupper", raciones:3, minutos:45, calentar:true, congela:true,
      ...
      pasos:"2 berenjenas partidas por la mitad (4 mitades) asadas 25 min. Vaciarlas, mezclar la pulpa con la boloñesa (B6), rellenar y gratinar con queso.",
    ...
    { id:"T12", nombre:"Albóndigas de lentejas en salsa", tipo:"tupper", raciones:3, minutos:40, calentar:true, congela:true,
      bases:[{id:"B1",porciones:3},{id:"B6",porciones:1}], salsas:[],
      fresco:[{n:"calabacín",c:"1",p:"verdura"},{n:"pan rallado",c:"",p:"despensa"},{n:"huevos",c:"1",p:"proteina"},{n:"arroz",c:"120 g",p:"despensa"}],
      pasos:"Albóndigas (B6, al horno) + 300 g de B1 + calabacín en dados, 10 min. Con 120 g de arroz blanco (40 g por ración).",
    ...
    { id:"T14", nombre:"Hamburguesas de lentejas + ensalada", tipo:"tupper", raciones:3, minutos:40, frio:true, congela:true,
      bases:[], salsas:["S2"],
      fresco:[{n:"tarro de lenteja cocida",c:"1",p:"tarros"},{n:"patata",c:"1",p:"verdura"},{n:"huevos",c:"1",p:"proteina"},{n:"pan rallado",c:"50 g",p:"despensa"},{n:"cebolla",c:"1",p:"verdura"},{n:"comino",c:"",p:"despensa"}],
      alDia:["la salsa de yogur, recién hecha"],
      pasos:"6 unidades (2 por ración). 1 tarro de lenteja escurrida (sin aliñar) + 1 patata cocida y chafada (da cuerpo y liga) + 1 huevo + 50 g de pan rallado + cebolla pochada + comino + pimentón. Formar y hornear a 200 °C, 20 min. Congelar separadas con papel.",
    ...
    { id:"T16", nombre:"Curry de huevo y patata", tipo:"tupper", raciones:3, minutos:25, calentar:true, congela:false,
      bases:[{id:"B2",porciones:3},{id:"B7",porciones:6}], salsas:[],
      fresco:[{n:"patata",c:"2",p:"verdura"},{n:"leche de coco",c:"150 ml",p:"despensa"}],
      pasos:"300 g de B2 + 2 patatas en dados + 150 ml de coco, 15 min. Añadir 2 huevos cocidos por ración partidos por la mitad.",
    ...
    { id:"T17", nombre:"Lasaña de calabacín y boloñesa", tipo:"tupper", raciones:3, minutos:50, calentar:true, congela:true,
      bases:[{id:"B6",porciones:1}], salsas:[],
      fresco:[{n:"calabacín",c:"2",p:"verdura"},{n:"leche",c:"300 ml",p:"proteina"},{n:"queso rallado",c:"80 g",p:"proteina"}],
      pasos:"2 calabacines en láminas finas (asados 10 min, para que suelten agua) en capas alternas con boloñesa (B6) + bechamel ligera (300 ml de leche, 20 g de harina, 15 g de mantequilla) + 80 g de queso. 190 °C, 30 min.",
    ...
    { id:"T18", nombre:"Pasta al horno con boloñesa", tipo:"tupper", raciones:3, minutos:40, calentar:true, congela:true,
      bases:[{id:"B6",porciones:1}], salsas:[],
      fresco:[{n:"pasta corta",c:"150 g",p:"despensa"},{n:"leche",c:"300 ml",p:"proteina"},{n:"queso rallado",c:"50 g",p:"proteina"}],
      pasos:"150 g de pasta corta cocida al dente + 1 porción de boloñesa (B6) + bechamel ligera (300 ml de leche, 20 g de harina, 15 g de mantequilla) + 50 g de queso rallado. 190 °C, 25 min.",
    ...
    { id:"T19", nombre:"Ensalada de pasta con pesto y mozzarella", tipo:"tupper", raciones:3, minutos:15, frio:true, congela:false,
      bases:[{id:"B3",porciones:1}], salsas:["S5"],
      fresco:[{n:"pasta corta",c:"180 g",p:"despensa"},{n:"mozzarella mini o feta",c:"125 g",p:"proteina"},{n:"tomate cherry",c:"250 g",p:"verdura"},{n:"piñones",c:"",p:"despensa"}],
      pasos:"180 g de pasta corta al dente, enfriada con un chorro de aceite + 2 cda de pesto + 125 g de mozzarella mini o feta + tomate cherry + verduras asadas (B3) + piñones.",
    ...
    { id:"T20", nombre:"Fideos fríos asiáticos con tofu", tipo:"tupper", raciones:3, minutos:15, frio:true, congela:false,
      bases:[{id:"B5",porciones:2}], salsas:["S3"],
      ...
      pasos:"200 g de fideos de arroz (3 min en agua caliente) + 200 g de tofu (B5) + pepino, zanahoria y col en juliana + cebolleta y cacahuete picado.",
    ...
    { id:"T22", nombre:"Arroz salteado con huevo y verduras", tipo:"tupper", raciones:3, minutos:15, calentar:true, congela:false,
      bases:[{id:"B8",porciones:1}], salsas:[],
      fresco:[{n:"arroz",c:"250 g",p:"despensa"},{n:"huevos",c:"3",p:"proteina"},{n:"guisantes y maíz",c:"1 bote",p:"tarros"},{n:"jengibre",c:"1 trozo",p:"verdura"}],
      pasos:"Arroz cocido del día anterior y frío (suelta mejor) + ajo y jengibre + zanahoria, cebolleta, guisantes y maíz (como acompañamiento, no como base) + 3 huevos revueltos (1 por ración) + soja y sésamo. Opcional: dados de tofu (B5).",
    ...
    { id:"T24", nombre:"Pasta de lenteja roja con tomate y feta", tipo:"tupper", raciones:3, minutos:15, calentar:true, frio:true, congela:false,
      ...
      pasos:"250 g de pasta de lenteja roja (sacarla 1–2 min antes de lo que diga el paquete; se pasa rápido) + 300 g de sofrito (B1) + tomate cherry asado + feta desmenuzado + albahaca.",
    ...
    { id:"T25", nombre:"Cuscús templado con verduras asadas y halloumi", tipo:"tupper", raciones:3, minutos:15, frio:true, congela:false,
      ...
      fresco:[{n:"cuscús",c:"150 g",p:"despensa"},{n:"halloumi o queso de cabra",c:"180 g",p:"proteina"},{n:"pasas",c:"",p:"despensa"},{n:"almendra",c:"",p:"despensa"},{n:"limón",c:"1",p:"verdura"},{n:"menta",c:"",p:"verdura"}],
      alDia:["salsa de yogur o tahini aparte"],
      pasos:"150 g de cuscús hidratado con caldo caliente, 5 min + verduras asadas (B3) + 180 g de halloumi o queso de cabra a la plancha + pasas, un puñado de almendras, limón y menta." },
    ...
    { id:"T26", nombre:"Ragú de soja texturizada", tipo:"tupper", raciones:3, minutos:25, calentar:true, congela:true,
      ...
      fresco:[{n:"zanahoria",c:"2",p:"verdura"},{n:"pasta o polenta",c:"200 g",p:"despensa"},{n:"parmesano",c:"",p:"proteina"},{n:"vino tinto",c:"",p:"despensa"}],
      pasos:"1 porción de soja fina hidratada y dorada (B9) + 300 g de sofrito (B1) + zanahoria picada + orégano y vino tinto, 20 min. Con 200 g de pasta o polenta (o calabacín asado) y parmesano por encima.",
    ...
    { id:"T27", nombre:"Pimientos rellenos de soja y arroz", tipo:"tupper", raciones:3, minutos:50, calentar:true, congela:true,
      ...
      pasos:"3 pimientos grandes partidos + relleno de soja fina (B9) + 200 g de sofrito (B1) + 150 g de arroz cocido + comino. Gratinar con queso, 190 °C, 30 min." },
    ...
    { id:"T29", nombre:"Guiso de soja texturizada y patata", tipo:"tupper", raciones:3, minutos:30, calentar:true, congela:true,
      ...
      pasos:"Soja gruesa (B9) + 300 g de sofrito (B1, 100 g por persona) + patata y zanahoria en dados + pimentón, laurel y caldo, 20 min.",
    ...
    { id:"F1", nombre:"Shakshuka con feta", tipo:"finde", raciones:2, minutos:20, calentar:true,
      bases:[{id:"B1",porciones:3}], salsas:[],
      fresco:[{n:"huevos",c:"4",p:"proteina"},{n:"feta",c:"100 g",p:"proteina"},{n:"pan",c:"80 g",p:"despensa"},{n:"comino",c:"",p:"despensa"}],
      pasos:"300 g de B1 + comino y pimentón. Hacer 4 huecos, poner los huevos, tapar y dejar 7 min. Feta y 80 g de pan." },
    ...
    { id:"F3", nombre:"Pasta con boloñesa de lentejas", tipo:"finde", raciones:2, minutos:15, calentar:true,
      bases:[{id:"B6",porciones:1}], salsas:[],
      fresco:[{n:"pasta",c:"150 g",p:"despensa"},{n:"parmesano",c:"",p:"proteina"}],
      pasos:"1 porción de B6 descongelada (da para 2 con holgura) + 150 g de pasta + parmesano. 15 min." },

    { id:"F4", nombre:"Berenjenas a la parmesana", tipo:"finde", raciones:3, minutos:45, calentar:true,
      bases:[{id:"B1",porciones:3}], salsas:[],
      fresco:[{n:"berenjena",c:"2",p:"verdura"},{n:"mozzarella",c:"2",p:"proteina"},{n:"parmesano",c:"",p:"proteina"}],
      pasos:"2 berenjenas en láminas asadas, en capas con 300 g de B1, 2 mozzarellas y parmesano. 190 °C, 30 min.",
    ...
    { id:"F6", nombre:"Curry de garbanzos y boniato", tipo:"finde", raciones:3, minutos:20, calentar:true,
      bases:[{id:"B2",porciones:3}], salsas:["S2"],
      ...
      pasos:"300 g de B2 + boniato en dados + coco, 15 min. + 1 tarro de garbanzo + espinacas. Yogur." },

    { id:"F7", nombre:"Bowl de hummus y verduras asadas", tipo:"finde", raciones:2, minutos:15, frio:true,
      bases:[{id:"B3",porciones:1}], salsas:[],
      fresco:[{n:"hummus",c:"150 g",p:"tarros"},{n:"pan de pita",c:"2",p:"despensa"},{n:"huevos",c:"2",p:"proteina"}],
      pasos:"150 g de hummus (bote o casero con garbanzo de bote) + B3 + 1 huevo por ración + pita tostada. Sin salsa de tahini: el hummus ya la lleva." },
    ...
    { id:"F9", nombre:"Alubias blancas con verduras", tipo:"finde", raciones:2, minutos:20, calentar:true,
      bases:[{id:"B1",porciones:2}], salsas:[],
      fresco:[{n:"tarro de alubia blanca",c:"1",p:"tarros"},{n:"espinaca",c:"100 g",p:"verdura"},{n:"caldo de verduras",c:"300 ml",p:"despensa"},{n:"huevos",c:"2",p:"proteina"},{n:"pan",c:"60 g",p:"despensa"}],
      pasos:"200 g de B1 + pimentón + 1 tarro de alubia + caldo + espinacas, 15 min. Escalfar 1 huevo por ración encima los últimos 5 min, tapado. Con pan." },

    { id:"F10", nombre:"Wok de fideos con tofu", tipo:"finde", raciones:2, minutos:20, calentar:true,
      bases:[{id:"B5",porciones:2},{id:"B8",porciones:1}], salsas:["S3"],
      fresco:[{n:"fideos de arroz",c:"120 g",p:"despensa"}],
      pasos:"120 g de fideos de arroz + 200 g de tofu (B5) + pimiento, zanahoria y col salteados + salsa de cacahuete." },

    { id:"F11", nombre:"Tortilla de patatas", tipo:"finde", raciones:3, minutos:40, frio:true,
      bases:[], salsas:[],
      fresco:[{n:"patata",c:"4",p:"verdura"},{n:"huevos",c:"6",p:"proteina"},{n:"cebolla",c:"1",p:"verdura"}],
      pasos:"La clásica.",
      nota:"Da para 2 y un tupper: el tercio que sobra va al lunes (se come en frío)." },

    { id:"F12", nombre:"Huevos rotos con pimientos asados", tipo:"finde", raciones:2, minutos:30, calentar:true,
      bases:[{id:"B3",porciones:1}], salsas:[],
      fresco:[{n:"patata",c:"2 grandes",p:"verdura"},{n:"huevos",c:"4",p:"proteina"}],
    ...
    { id:"F13", nombre:"Pasta carbonara vegetariana", tipo:"finde", raciones:2, minutos:20, calentar:true,
      bases:[], salsas:[],
      fresco:[{n:"espaguetis",c:"160 g",p:"despensa"},{n:"huevos",c:"3",p:"proteina"},{n:"parmesano",c:"",p:"proteina"},{n:"setas o calabacín",c:"250 g",p:"verdura"}],
      pasos:"160 g de espaguetis + setas o calabacín salteados + 2 yemas y 1 huevo + parmesano + pimienta, fuera del fuego y con agua de cocción." },

    { id:"F14", nombre:"Lasaña clásica de boloñesa de lentejas", tipo:"finde", raciones:4, minutos:50, calentar:true,
      bases:[{id:"B6",porciones:1}], salsas:[],
      fresco:[{n:"placas de lasaña",c:"12",p:"despensa"},{n:"leche",c:"400 ml",p:"proteina"},{n:"queso rallado",c:"100 g",p:"proteina"}],
      pasos:"1 porción de B6 + 12 placas + bechamel ligera (400 ml de leche, 30 g de harina, 25 g de mantequilla) + 100 g de queso. 190 °C, 35 min." },

    { id:"F15", nombre:"Pad thai de tofu y huevo", tipo:"finde", raciones:2, minutos:25, calentar:true,
      bases:[{id:"B5",porciones:1},{id:"B8",porciones:1}], salsas:[],
      fresco:[{n:"fideos de arroz",c:"150 g",p:"despensa"},{n:"pasta de tamarindo",c:"",p:"despensa"},{n:"huevos",c:"2",p:"proteina"},{n:"cacahuete",c:"1 puñado",p:"despensa"},{n:"lima",c:"1",p:"verdura"},{n:"brotes de soja",c:"",p:"verdura"}],
      pasos:"Fideos de arroz + 100 g de tofu (B5) + 2 huevos + salsa de tamarindo, soja y azúcar + brotes, cacahuete y lima." },
